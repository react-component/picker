...
const locale: Locale = {
  ...
  minutes: 'Minutlar',
  seconds: 'Sekundlar',
  milliseconds: 'Millisaniyeler',
  timeSelect: 'Wagt saýla',
  dateSelect: 'Gün saýla',
  monthSelect: 'Aý saýla',
  yearSelect: 'Ýyl saýla',
  decadeSelect: 'On ýyllygy saýla',
  hourSelect: 'Sagat saýlaň',
  minuteSelect: 'Minut saýlaň',
  secondSelect: 'Sekunt saýlaň',
  millisecondSelect: 'Millisekunt saýlaň',
  meridiemSelect: 'Meridiemi saýlaň',
