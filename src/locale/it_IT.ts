...
const locale: Locale = {
  ...
  hourSelect: "Seleziona un'ora",
  minuteSelect: 'Seleziona un minuto',
  secondSelect: 'Seleziona un secondo',
  millisecondSelect: 'Seleziona un millisecondo',
  meridiemSelect: 'Seleziona il meridiano',
